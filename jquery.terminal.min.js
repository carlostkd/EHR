...
(function (r, i) {
        ...
        iterate_formatting: function e(t, n) {
            ...
            for (var w = 0; w < t.length; w++) {
                ...
                if (o(w)) {
                    ...
                    var R = { last: p(), count: h, index: w - C, formatting: m, length: b, text: d, size: S, space: g, space_count: _ };
                    var j = n(R);
                    if (j === false) {
                        break;
                    } else if (j) {
                    ...
                    n({ last: true, count: h + 1, index: w, formatting: m, length: 0, text: d, space: g });
                }
                if (d) {
                    w += l();
                }
    ...
    $.jrpc = function (e, t, n, r, i) {
        ...
        var u = { jsonrpc: "2.0", method: o.method, params: o.params, id: ++ids[o.url] };
        $.ajax({
            url: o.url,
    ...
    var copyright = "Copyright (c) 2023 Sophie Powered AI " + "<https://carlostkd.ch>";
    
    
    var name_ver = "EHR TERMINAL" );
    ...
    $.fn.terminal = function (e, t) {
        ...
        function X(t, a, n) {
            ...
            if (e === "array") {
                ...
                (function t(e, n) {
                    ...
                    n({ interpreter: Y(o, false, a, l && l.bind(g)), completion: Object.keys(o) });
                });
            } else if (e === "string") {
                if (C.describe === false) {
                    o = { interpreter: Q(t, a) };
                ...
                n({ interpreter: Y(t, C.checkArity, a), completion: Object.keys(t) });
            } else {
                if (e === "undefined") {
                    t = $.noop;
                } else if (e !== "function") {
                ...
                return $.terminal.each_extended_command(e, function (e) {
                    if (r.exec) {
                        ...
                        if (_ && _ === t) {
                            ...
                            _ = t;
                            $.terminal.extended_command(g, e, { invokeMethods: r.invokeMethods }).then(function () {
                                _ = "";
                            });
                        }
                    }
        ...
        function re(t) {
            try {
                ...
                var n = $.extend({ exec: true, raw: false, finalize: $.noop, useCache: e, invokeMethods: false, formatters: true, convertLinks: C.convertLinks }, t.options || {});
                var r = pt(t.value);
        ...
        var Ee = {
            ...
            TAB: function (e, t) {
                ...
                function u(e) {
                    ...
                    g.complete(e, { echo: true, word: C.wordAutocomplete, escape: C.completionEscape, caseSensitive: i, echoCommand: C.doubleTabEchoCommand, doubleTab: C.doubleTab });
                }
                if (r) {
                    switch (get_type(r)) {
                        case "function":
        ...
        var Ie = $.omap(
            {
                ...
                export_view: function () {
                    var e = v("onExport");
                    e = e || {};
                    return $.extend({}, { focus: x, mask: T.mask(), prompt: g.get_prompt(), command: g.get_command(), position: T.position(), lines: clone(w.data()), interpreters: B.clone(), history: T.history().data }, e);
                },
                ...
                exec: function (r, i, u) {
                    ...
                    var o = $.extend({ deferred: null, silent: false, typing: false, delay: C.execAnimationDelay }, u);
                    if (i === null) {
                        i = o.silent;
                    }
                        ...
                        if (++Ne >= 2) {
                            ...
                            if (i.echo) {
                                if (is_function(i.doubleTab)) {
                                    ...
                                    g.echo($.terminal.escape_brackets(m), { keepWords: true, formatters: false });
                                }
                                return true;
                            }
                        } else {
                ...
                geometry: function () {
                    ...
                    var i = e("top");
                    var u = e("bottom");
                    return { terminal: { padding: { left: n, right: r, top: i, bottom: u }, width: Ge + n + r, height: Xe + i + u }, density: L, char: I, cols: this.cols(), rows: this.rows() };
                },
                ...
                refresh: function () {
                    if (I.width !== 0) {
                        css(g[0], { "--char-width": I.width, "--pixel-density": L });
                    }
                    g.clear_cache();
                    if (He) {
                        T.resize();
                    ...
                    f(function e() {
                        try {
                            ...
                            if (l.length === 0) {
                                ...
                                css(T[0], { top: -i.height / L + "px", "--prompt-offset": c });
                            ...
                            g.stopTime("flush").oneTime(1, "flush", function () {
                                css(g[0], { "--terminal-height": g.height(), "--terminal-x": D.left - m.left, "--terminal-y": D.top - m.top, "--terminal-scroll": g.prop("scrollTop") });
                                if (x) {
                                    p.hide();
                ...
                read: function (e, t, n) {
                    ...
                    if (typeof arguments[1] === "object") {
                        r = $.extend({ typing: false, delay: C.execAnimationDelay, success: $.noop, cancel: $.noop }, arguments[1]);
                    } else {
        ...
        var Ge, Xe;
        var Ze = [];
        var C = $.extend({}, $.terminal.defaults, { name: g.selector, exit: !!((t && t.login) || !t) }, t || {});
        ...
        var F = new FormatBuffer(function (e) {
            return { linksNoReferrer: C.linksNoReferrer, linksNoFollow: C.linksNoFollow, anyLinks: C.anyLinks, charWidth: I.width, useCache: C.useCache, escape: false, allowedAttributes: e.allowedAttributes || [] };
        });
        ...
        X(e, C.login, function (e) {
            ...
            B = new Stack($.extend({}, C.extra, { name: C.name, prompt: t, keypress: C.keypress, keydown: C.keydown, resize: C.onResize, greetings: C.greetings, mousewheel: C.mousewheel, history: C.history, keymap: N }, e));
            T = $("<div/>")
                .appendTo(j)
                .cmd({
                    tabindex: C.tabindex,
            ...
            function s() {
                if (window.IntersectionObserver) {
                    ...
                    Ye = new IntersectionObserver(o, { root: R[0], rootMargin: "0px", threshold: 1 });
                    Ye.observe(t[0]);
                }
            }
            s();
            ...
            function l() {
                ...
                if (window.IntersectionObserver && g.css("position") !== "fixed") {
                    S = new IntersectionObserver(n, { root: null });
                    S.observe(g[0]);
                } else {
                    S = setInterval(n, 100);
                }
